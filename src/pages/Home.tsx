...
            className='absolute inset-0 bg-black/50 backdrop-brightness-75'
          ></motion.div>
...
          <motion.h1 
            initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, ease: smoothEase }} 
...
              <motion.h1 
                variants={fadeInUp}
                className='text-4xl font-extrabold tracking-tight text-primary mb-6'
              >
                Volunteer
              </motion.h1>
              
...
                whileInView="visible"
                viewport={{ once: true, amount: 0.1 }}
                className='bg-card p-6 sm:p-8 rounded-xl shadow-2xl border border-border space-y-5'
              >
                <motion.h2 variants={fadeInUp} className='text-2xl font-bold text-foreground mb-4'>Become a volunteer today</motion.h2>
                
...
                ))}
                
                <motion.label variants={fadeInUp} className='block w-full text-sm font-medium text-foreground/70 pt-2'>
                    Upload your CV
                    <motion.input 
...
                <motion.h3 variants={fadeInUp} className='text-2xl font-bold text-foreground'>About Volunteering</motion.h3>
                <motion.p variants={fadeInUp} className='text-muted-foreground leading-relaxed'>
...
                </motion.p>
                <motion.p variants={fadeInUp} className='text-sm text-primary/80 pt-2'>
